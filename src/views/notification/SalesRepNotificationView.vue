...
const badgeClass = (category) => {
  ...
  if (category === '계정') return 'badge-account'
  return 'badge-stock'
}
...
<template>
  <section class="screen-content">
    <PageHeader title="알림" subtitle="영업사원용 알림을 확인하고 상태를 관리합니다." />
...
.badge-stock { background: #f3e8ff; color: #6b21a8; }
