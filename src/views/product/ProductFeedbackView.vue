...
// Flat messages to nested structure
  ...
  <div class="fixed inset-0 top-[60px] left-0 md:left-[250px] bg-[#f0f2f5] flex flex-col transition-all duration-300">
    ...
    <div id="commentContainer" class="flex-1 p-5 overflow-y-auto flex flex-col gap-3">
      <template v-for="parent in nestedMessages" :key="parent.id">
        ...
        >
          <!-- Arrow Icon using pseudo-element style simulation -->
...
<style scoped>
/* Scoped styles can be used if needed, but Tailwind classes cover most requirements */
</style>
